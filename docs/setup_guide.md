...
**⚠️ 如果您遇到任何错误：**
- `relation "public.profiles" does not exist` → 请直接运行 `database_schema.sql`
- `trigger already exists` → 现在的脚本已修复此问题，可重新运行
- 其他问题请参考 `docs/quick_setup.md` 详细说明
