...
export async function getGeminiResponse(
  ...
  try {
    ...
    const fallbackResponses = [
      "I'm here to listen and support you. Sometimes technology has hiccups, but my care for your wellbeing is constant. Could you share a bit more about what you're experiencing?",
      "I apologize for the technical difficulty. What's most important is that you're reaching out. How are you feeling right now, and what's on your mind?",
